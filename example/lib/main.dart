...
''';
  ...
  Future<void> init() async {
    await _ttsPlugin.ttsMapping
        .loadIPAsMapping('assets/tts/en_tts_mapping.csv', language: 'en');
    await _ttsPlugin.ttsMapping
        .loadIPAsMapping('assets/tts/id_tts_mapping.csv', language: 'id');
